...
const { Editor } = require('@jianghe/slate-react')
        ...
        <block type="level-two">
          <block type="coffee-container">
            ...
            <inline type="coffee">
              ...
              cultivar doppio café au lait. Dripper irish fair trade <anchor />
              kopi-luwak ut beans skinny saucer.
            </inline>
            <text />
          </block>
          <block type="coffee-container">
            ...
            <text>
              ...
              flavour cultivar acerbic half and half et
              <focus /> cappuccino.
            </text>
            <inline type="coffee">
